...
class ProductsTableSeeder extends Seeder {
	...
	public function run() {
		...
		Product::create([
			...
			'emailImage' => asset('img/email-assets/thumbs/niner-e.png'),
			'name' => '9\'ER',
		...
		Product::create([
			...
			'emailImage' => asset('img/email-assets/thumbs/superhero-e.png'),
			'name' => 'SuperHero',
		...
		Product::create([
			...
			'emailImage' => asset('img/email-assets/thumbs/comfort-e.png'),
			'name' => 'Comfort',
