<div class="store-container" ng-controller="StoreController">
	...
	{{-- <div class="extras-row product-row">
		...
		<div class="product-thumb-container"><img src="{{ asset('img/thumbs/band.png') }}"></div>
	...
	<div class="extras-links links">
		...
		<div class="product-link-container"><a href="">Inshore Shrinker</a></div>
		<div class="product-link-container"><a href="">Budk Knife</a></div>
		<div class="product-link-container"><a href="">Bands</a></div>
